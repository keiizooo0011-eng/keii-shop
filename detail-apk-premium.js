(()=>{
 ...
 const labels={pending:'Menunggu pembayaran',paid:'Menunggu data dari admin',processing:'Sedang diproses',completed:'Pesanan selesai',cancelled:'Dibatalkan',failed:'Gagal'};
